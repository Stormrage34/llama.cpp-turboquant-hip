...
// Custom KV cache quant types (turbo, planar, iso)
...
GGML_API void quantize_row_turbo4_0_kv_ref(const float * GGML_RESTRICT x, block_turbo4_0 * GGML_RESTRICT y, int64_t k);
