...
void ggml_cuda_launch_mm_ids_helper(
    ...
    // Use the generic implementation for any number of experts used.
    // This eliminates multiple specialized kernel instantiations and reduces kernel launch overhead.
